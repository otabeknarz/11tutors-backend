"""
Django settings for eleven_tutors project.
...
DEBUG = os.getenv("DJANGO_DEBUG", "0").lower() in ("true", "1", "yes")
...
ROOT_URLCONF = "eleven_tutors.urls"
...
WSGI_APPLICATION = "eleven_tutors.wsgi.application"
